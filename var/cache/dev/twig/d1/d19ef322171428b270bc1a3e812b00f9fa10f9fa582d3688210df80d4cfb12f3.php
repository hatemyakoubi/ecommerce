...
class __TwigTemplate_76b20769054b760f77dd8f45c640df332051d0597046b2f51d253973e909c601 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        ...
        echo "\" class =\"btn btn-success\" style=\"margin-right: 15px;\" >edit</a>
...
";
    ...
    {
        return array (  158 => 49,  153 => 47,  148 => 45,  143 => 42,  138 => 36,  131 => 32,  124 => 28,  117 => 24,  110 => 20,  103 => 16,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <table class=\"table\">
        <tbody>
            ...
            {# <tr>
                <th>Image</th>
                <td>{{ produit.images }}</td>
            </tr> #}
        </tbody>
    </table>

    <a href=\"{{ path('produit_index') }}\" class=\"btn btn-warning\" >back to list</a>

    <a href=\"{{ path('produit_edit', {'id': produit.id}) }}\" class =\"btn btn-success\" style=\"margin-right: 15px;\" >edit</a>

    {{ include('produit/_delete_form.html.twig') }}
{% endblock %}
", "produit/show.html.twig", "C:\\Users\\Fayna\\Downloads\\e-commerce-master\\e-commerce-master\\templates\\produit\\show.html.twig");
    }
}
